...
export type { IWeightService } from "./weight.service";
...
export type { CreateWeightDtoType } from "./dtos/create-weight.dto";
export { WeightQueryDto, WeightQueryDtoSchema } from "./dtos/weight-query.dto";
export type { WeightQueryDtoType } from "./dtos/weight-query.dto";
export {
  ApiErrorResponse,
...
export type { WeightEntry } from "./types/weight.types";
...
export const WeightModuleMetadata = {
  ...
  version: "1.0.0",
  description:
    "體重管理模組 - 使用 @asla/hono-decorator 實現類似 NestJS 的架構",
  routes: [
    "POST /weight - 新增體重記錄",
    "GET /weight - 取得體重記錄列表",
