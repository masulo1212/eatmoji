...
/**
 * RecipeDelete endpoint - 軟刪除食譜
 * 對應 Flutter 的 deleteRecipe 方法
 */
export class RecipeDelete extends OpenAPIRoute {
  public schema = {
    tags: ["Recipes"],
    summary: "刪除食譜",
  ...
  public async handle(c: AppContext) {
    try {
      ...
      const response = await recipeController.deleteRecipe(recipeId);
      ...
      console.error("Endpoint: RecipeDelete 處理錯誤:", error);
