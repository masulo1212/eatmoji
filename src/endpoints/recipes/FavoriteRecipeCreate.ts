...
/**
 * FavoriteRecipeCreate endpoint - 加入收藏食譜
 * 對應 Flutter 的 addFavRecipe 方法
 */
export class FavoriteRecipeCreate extends OpenAPIRoute {
  public schema = {
  ...
  public async handle(c: AppContext) {
    try {
      ...
      const response = await recipeController.addToFavorites(userId, recipeId);
      ...
      console.error("Endpoint: FavoriteRecipeCreate 處理錯誤:", error);
